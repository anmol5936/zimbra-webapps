...
AjxTemplate.register("share.Dialogs#ZmTwoFactorCustomLoginPage", 
function(name, params, data, buffer) {
	var _hasBuffer = Boolean(buffer);
	data = (typeof data == "string" ? { id: data } : data) || {};
	buffer = buffer || [];
	...
	buffer[_i++] = "<div class=\"ZmTwoFactorCustomSetupLoginPage\"><div class=\"logo\"><div class=\"ImgLoginBanner\"></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_description'><h2 class=\"ZmTwoFactorCustomTitleLoginPage\" >";
	buffer[_i++] = ZmMsg.twoStepAuthSetup;
	buffer[_i++] = "</h2><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthDescription;
	buffer[_i++] = "</p></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password'><h2 class=\"ZmTwoFactorCustomTitleLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthPassword;
	buffer[_i++] = "</h2><p id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_error' style=\"display:none;\" class=\"ZmTwoFactorCustomSetupErrorLoginPage\">";
	buffer[_i++] = ZmMsg.offlinePasswordUpdateFailure;
	buffer[_i++] = "</p><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthPasswordDescription;
	buffer[_i++] = " \"";
	buffer[_i++] = data["username"];
	buffer[_i++] = "\".</p><label class=\"passwordCustomLabel\" for=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_input\">";
	buffer[_i++] = ZmMsg.password;
	buffer[_i++] = "</label><div class=\"ZmTwoFactorCustomInputLoginPage\"><input class=\"inputTag\" type=\"password\" id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_input\" autocomplete=\"off\"/></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_authentication'><h2 class=\"ZmTwoFactorCustomTitleLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthApp;
	buffer[_i++] = "</h2><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthAppDescription;
	buffer[_i++] = "</p><p class=\"ZmTwoFactorCustomParaLoginPage\"><a href=\"";
	buffer[_i++] = ZmMsg.twoStepAuthAppURL;
	buffer[_i++] = "\" target=\"_blank\" title=\"";
	buffer[_i++] = ZmMsg.twoStepAuthAppURL;
	buffer[_i++] = "\">";
	buffer[_i++] = ZmMsg.twoStepAuthAppURL;
	buffer[_i++] = "</a></p><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthAppFooter;
	buffer[_i++] = "</p></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_email'><h2 class=\"ZmTwoFactorCustomTitleLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthEmail;
	buffer[_i++] = "</h2><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthEmailDescription;
	buffer[_i++] = "</p><div class=\"ZmTwoFactorCustomSetupContainerLoginPage\"><span id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_email_key\" class=\"email-key\"></span></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_code'><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_code_description'><h2 class=\"ZmTwoFactorCustomTitleLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthCode;
	buffer[_i++] = "</h2><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthCodeDescription;
	buffer[_i++] = "</p></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_code_error' style=\"display:none;\"><h2 class=\"ZmTwoFactorCustomTitleLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthCode;
	buffer[_i++] = "</h2><div class=\"ZmTwoFactorCustomSetupErrorLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthCodeError;
	buffer[_i++] = "</div><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthCodeErrorDescription;
	buffer[_i++] = "</p></div><div class=\"ZmTwoFactorCustomInputLoginPage\"><input class=\"numberInputTag\" type=\"number\" id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_code_input\" placeholder=\"e.g. 123456\" autocomplete=\"off\"/></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_success'><h2 class=\"ZmTwoFactorCustomTitleLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthSuccess;
	buffer[_i++] = "</h2><p class=\"ZmTwoFactorCustomParaLoginPage\">";
	buffer[_i++] = ZmMsg.twoStepAuthSuccessDescription;
	buffer[_i++] = "</p></div></div>";
...
{
	"id": "share.Dialogs#ZmTwoFactorCustomLoginPage"
}, false);

AjxTemplate.register("share.Dialogs#ZmPasswordRecovery", 
function(name, params, data, buffer) {
	var _hasBuffer = Boolean(buffer);
	data = (typeof data == "string" ? { id: data } : data) || {};
	buffer = buffer || [];
	...
	buffer[_i++] = "<div class=\"ZmPasswordRecoverySetup\"><div class=\"logo\"><div class=\"ImgLoginBanner\"></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_get_recovery_account'><h2 class=\"ZmPasswordRecoveryCustomTitle\">";
	buffer[_i++] = ZmMsg.passwordRecoveryTitle;
	buffer[_i++] = "</h2><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_account_input_error' style='display:none;' class='ZmPasswordRecoverySetupError'><span id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_account_input_error_message'>";
	buffer[_i++] = ZmMsg.offlinePasswordUpdateFailure;
	buffer[_i++] = "</span></div><p class=\"ZmPasswordRecoveryCustomPara\">";
	buffer[_i++] = ZmMsg.passwordRecoveryGetAccountDescription;
	buffer[_i++] = "</p><div class='ZmPasswordRecoverySetupContainer'><input type='text' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_account_input' placeholder=\"Email\" size='35' autocomplete='off'/></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_request_code'><h2 class=\"ZmPasswordRecoveryCustomTitle\">";
	buffer[_i++] = ZmMsg.passwordRecoveryTitle;
	buffer[_i++] = "</h2><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_request_code_error' style='display:none;' class='ZmPasswordRecoverySetupError'><span id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_request_code_error_message'>";
	buffer[_i++] = ZmMsg.offlinePasswordUpdateFailure;
	buffer[_i++] = "</span></div><p class=\"ZmPasswordRecoveryCustomPara\" id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_request_code_description'></p></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_validate_code'><h2 class=\"ZmPasswordRecoveryCustomTitle\">";
	buffer[_i++] = ZmMsg.passwordRecoveryTitle;
	buffer[_i++] = "</h2><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_validate_code_error' style='display:none;' class='ZmPasswordRecoverySetupError'><span id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_validate_code_error_message'>";
	buffer[_i++] = ZmMsg.passwordRecoveryCodeValidationError;
	buffer[_i++] = "</span></div><p class=\"ZmPasswordRecoveryCustomPara\" id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_validate_code_description'>";
	buffer[_i++] = ZmMsg.passwordRecoveryCodeValidationDescription;
	buffer[_i++] = "</p><div class='ZmPasswordRecoverySetupContainer'><input type='text' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_code_input' placeholder=\"Code\" size='35' autocomplete='off'/></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_code_success'><h2 class=\"ZmPasswordRecoveryCustomTitle\">";
	buffer[_i++] = ZmMsg.passwordRecoveryTitle;
	buffer[_i++] = "</h2><p class=\"ZmPasswordRecoveryCustomPara\">";
	buffer[_i++] = ZmMsg.passwordRecoveryCodeSuccessDescription;
	buffer[_i++] = "</p><div class=\"alignButton\"><button id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_RESET_PASSWORD' class='ZmPasswordRecoveryButton' tabindex=0></button><button id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_CONTINUE_BUTTON' class='ZmPasswordRecoveryButton' tabindex=0></button></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_reset_password'><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_reset_password_description'><h2 class=\"ZmPasswordRecoveryCustomTitle\">";
	buffer[_i++] = ZmMsg.recoveryEmailButtonResetPassword;
	buffer[_i++] = "</h2></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_reset_password_error' style='display:none;' class='ZmPasswordRecoverySetupError'><span id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_reset_password_error_message'>";
	buffer[_i++] = ZmMsg.passwordRecoveryResetError;
	buffer[_i++] = "</span></div><div class='ZmPasswordRecoverySetupContainer'><label for='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_new_input'>";
	buffer[_i++] = ZmMsg.passwordRecoveryResetNewLabel;
	buffer[_i++] = "</label><div class=\"passwordWrapper\"><input type='password' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_new_input' size='35' autocomplete='off'/><span id=\"newPasswordShowSpan\" style=\"display: block;\">";
	buffer[_i++] = ZmMsg.show;
	buffer[_i++] = "</span><span id=\"newPasswordHideSpan\" style=\"display: none;\">";
	buffer[_i++] = ZmMsg.hide;
	buffer[_i++] = "</span></div><ul id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_rule_list\" class=\"resetPasswordRuleList\"><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_length\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"minLengthCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"minLengthCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_length_label\" class=\"ZmPasswordRecoveryRule\"/></li><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_upper_case_chars\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"minUpperCaseCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"minUpperCaseCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_upper_case_chars_label\" class=\"ZmPasswordRecoveryRule\"/></li><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_lower_case_chars\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"minLowerCaseCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"minLowerCaseCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_lower_case_chars_label\" class=\"ZmPasswordRecoveryRule\"/></li><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_punctuation_chars\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"minPunctuationCharsCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"minPunctuationCharsCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_punctuation_chars_label\" class=\"ZmPasswordRecoveryRule\"/></li><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_numeric_chars\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"minNumericCharsCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"minNumericCharsCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_numeric_chars_label\" class=\"ZmPasswordRecoveryRule\"/></li><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_digits_or_punctuations\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"minDigitsOrPuncsCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"minDigitsOrPuncsCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_min_digits_or_punctuations_label\" class=\"ZmPasswordRecoveryRule\"/></li><li id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_allow_username\"><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"allowUsernameCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"allowUsernameCheckImg\" style=\"display: none;\"/><label id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_allow_username_label\" class=\"ZmPasswordRecoveryRule\"/></li></ul><label for='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_confirm_input'>";
	buffer[_i++] = ZmMsg.passwordRecoveryResetConfirmLabel;
	buffer[_i++] = "</label><div class=\"passwordWrapper\"><input type='password' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_confirm_input' size='35' autocomplete='off'/><span id=\"confirmShowSpan\" style=\"display: block;\">";
	buffer[_i++] = ZmMsg.show;
	buffer[_i++] = "</span><span id=\"confirmHideSpan\" style=\"display: none;\">";
	buffer[_i++] = ZmMsg.hide;
	buffer[_i++] = "</span></div><ul class=\"confirmResetPasswordRuleList\"><li><img src=\"/img/zimbra/ImgCloseGrayModern.png\" id=\"mustMatchCloseImg\" style=\"display: inline;\"/><img src=\"/img/zimbra/ImgCheckModern.png\" id=\"mustMatchCheckImg\" style=\"display: none;\"/><label class=\"ZmPasswordRecoveryRule\">";
	buffer[_i++] = ZmMsg.zimbraPasswordMustMatch;
	buffer[_i++] = "<label></li></ul></div></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_password_reset_success'><h2 class=\"ZmPasswordRecoveryCustomTitle\">";
	buffer[_i++] = ZmMsg.passwordRecoveryResetSuccessTitle;
	buffer[_i++] = "</h2><p class=\"ZmPasswordRecoveryCustomPara\">";
	buffer[_i++] = ZmMsg.passwordRecoveryResetSuccessDescription;
	buffer[_i++] = "</p></div><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_two_factor_code'><h2 class=\"ZmPasswordRecoveryTwoFactorTitle\">";
	buffer[_i++] = ZmMsg.twoStepAuth;
	buffer[_i++] = "</h2><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_validate_two_factor_code_error' style='display:none;' class='ZmPasswordRecoverySetupError'><span id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_validate_two_factor_code_error_message'>";
	buffer[_i++] = ZmMsg.passwordRecoveryCodeValidationError;
	buffer[_i++] = "</span></div><div class='ZmPasswordRecoverySetupContainer'><label for='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_two_factor_code_input'>";
	buffer[_i++] = ZmMsg.twoFactorAuthCodeLabel;
	buffer[_i++] = "</label><input type='text' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_two_factor_code_input' size='35' autocomplete='off' class=\"ZmPasswordRecoveryTwoFactorCodeInout\"/><div id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_trust_device_section'><td><input type=\"checkbox\" id=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_trust_device_input\" name=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_trust_device_input\" value=\"true\"/></td><td><label for=\"";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_trust_device_input\" class=\"ZmPasswordRecoveryTrustDevice\">";
	buffer[_i++] = ZmMsg.twoFactorAuthTrustDevice;
	buffer[_i++] = "</label></td></div></div></div></div>";

	return _hasBuffer ? buffer.length : buffer.join("");
},
{
	"id": "share.Dialogs#ZmPasswordRecovery"
}, false);
