...
function(name, params, data, buffer) {
	...
	buffer[_i++] = "Table Z";
	buffer[_i++] = buttonClass;
	buffer[_i++] = "Border'style='table-layout:auto;'><tr role='none'><td role='none' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_left_icon'  \tclass='ZLeftIcon ZWidgetIcon'></td><td role='none' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_title'\t\tclass='ZWidgetTitle'></td><td role='none' id='";
	buffer[_i++] = data["id"];
	buffer[_i++] = "_right_icon' \tclass='ZRightIcon ZWidgetIcon'></td><td role='none' id='";
	buffer[_i++] = data["id"];
...
function(name, params, data, buffer) {
	...
	buffer[_i++] = " autocomplete='off' aria-autocomplete='list' class='addrInputField user_font_system' id='";
