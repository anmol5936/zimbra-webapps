...
<script type="text/javascript" src="<%=contextPath%>/js/zimbraMail/share/view/dialog/ZmPasswordRecoveryDialog.js?v=<%=vers%>"></script>
<script type="text/javascript">
AjxPackage.define("PasswordRecovery");
...
AjxPackage.define("zimbraMail.share.view.dialog.ZmPasswordRecoveryDialog");
</script>
