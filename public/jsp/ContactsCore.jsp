...
<script type="text/javascript" src="<%=contextPath%>/js/zimbraMail/abook/controller/ZmHabTreeController.js?v=<%=vers%>"></script>
...
AjxPackage.define("zimbraMail.abook.controller.ZmHabTreeController");
